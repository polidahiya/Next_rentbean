            ...
            return (
              <tr key={j} className="relative">
                ...
                <td className="p-[8px] text-center">
                  ...
                  to <span contentEditable="true">{invoicedata?.enddate}</span>
                </td>
                <td className="p-[8px] text-center">
                  <span contentEditable="true">
