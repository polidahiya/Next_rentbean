...
function page() {
  return (
    <div className="p-[10px] md:p-[40px]">
      ...
      <h2 className="font-bold text-[16px] mt-[20px]">2. Use of Information</h2>
      <p className="text-[14px]  ">
      ...
      <h2 className="font-bold text-[16px] mt-[20px]">3. Data Security</h2>
      <p className="text-[14px]  ">
      ...
      <h2 className="font-bold text-[16px] mt-[20px]">4. Data Sharing</h2>
      <p className="text-[14px]  ">
      ...
      <h2 className="font-bold text-[16px] mt-[20px]">5. Legal Compliance</h2>
      <p className="text-[14px]  ">
        We may disclose your information when required by law or in response to
        lawful requests by public authorities, including to meet national
        security or law enforcement requirements.
      </p>
      <h2 className="font-bold text-[16px] mt-[20px]">6. Consent</h2>
      <p className="text-[14px]  ">
      ...
      <h2 className="font-bold text-[16px] mt-[20px]">8. Contact Us</h2>
      <p className="text-[14px]  ">
        If you have any questions or concerns regarding this Privacy Policy or
        the handling of your personal information, please contact us at [contact
        email or address].
      </p>
    </div>
  );
