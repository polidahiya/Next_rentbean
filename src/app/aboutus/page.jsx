...
function page() {
  return (
    <div className="px-[10px] pb-[10px] md:px-[40px] md:pb-[40px]">
      <div className="aboutusheading font-black text-[15vw] lg:text-[12vw]">
        Rentbean.in
      </div>
      <center>
      ...
      <div>
        <h2 className="text-[16px] font-bold mt-[10px]">Our Story:</h2>
        ...
        <h2 className="text-[16px] font-bold mt-[10px]">What We Offer:</h2>
        <p className="text-[14px] ">
        ...
        <h2 className="text-[16px] font-bold mt-[10px]">Convenience:</h2>
        <p className="text-[14px] ">
        ...
        <h2 className="text-[16px] font-bold mt-[10px]">
          Quality Assurance:
        </h2>
        <p className="text-[14px] ">
        ...
        <h2 className="text-[16px] font-bold mt-[10px]">Our Commitment:</h2>
        <p className="text-[14px] ">
