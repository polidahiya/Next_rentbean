...
function page() {
  return (
    <div className="px-[10px] pb-[10px] md:px-[40px] md:pb-[40px]">
      <div className="aboutusheading font-black text-[15vw] lg:text-[12vw] font-recline">
        Rentbean.in
      </div>
      <center>
      ...
      <div>
        <h2 className="text-[18px] font-black  mt-[10px] font-recline">Our Story:</h2>
        ...
        <h2 className="text-[18px] font-black  mt-[10px] font-recline">What We Offer:</h2>
        <p className="text-[14px] ">
        ...
        <h2 className="text-[18px] font-black  mt-[10px] font-recline">Convenience:</h2>
        <p className="text-[14px] ">
        ...
        <h2 className="text-[18px] font-black  mt-[10px] font-recline">Our Commitment:</h2>
        <p className="text-[14px] ">
